i;8;CPView.ji;12;CPClipView.ji;12;CPScroller.jc;25430;
...
},["BOOL"]), new objj_method(sel_getUid("_headerView"), function $CPScrollView___headerView(self, _cmd)
{ with(self)
{
    var documentView = objj_msgSend(self, "documentView");
...
},["CPView"]), new objj_method(sel_getUid("_cornerView"), function $CPScrollView___cornerView(self, _cmd)
{ with(self)
{
    var documentView = objj_msgSend(self, "documentView");
...
},["CPView"]), new objj_method(sel_getUid("cornerViewFrame"), function $CPScrollView__cornerViewFrame(self, _cmd)
{ with(self)
{
    var cornerView = objj_msgSend(self, "_cornerView"),
...
},["CGRect"]), new objj_method(sel_getUid("headerClipViewFrame"), function $CPScrollView__headerClipViewFrame(self, _cmd)
{ with(self)
{
