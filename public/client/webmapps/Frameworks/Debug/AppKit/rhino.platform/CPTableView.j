I;20;Foundation/CPArray.ji;11;CPControl.ji;15;CPTableColumn.ji;15;_CPCornerView.ji;12;CPScroller.jc;60038;
...
},["CPInteger","CGPoint"]), new objj_method(sel_getUid("frameOfDataViewAtColumn:row:"), function $CPTableView__frameOfDataViewAtColumn_row_(self, _cmd, aColumnIndex, aRowIndex)
{ with(self)
{
...
},["void"]), new objj_method(sel_getUid("_sizeToParent"), function $CPTableView___sizeToParent(self, _cmd)
{ with(self)
{
...
},["void","CPIndexSet","CPIndexSet"]), new objj_method(sel_getUid("setFrameSize:"), function $CPTableView__setFrameSize_(self, _cmd, aSize)
{ with(self)
{
