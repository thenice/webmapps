I;21;Foundation/CPBundle.ji;17;CPCompatibility.ji;9;CPEvent.ji;8;CPMenu.ji;13;CPResponder.ji;22;CPDocumentController.ji;14;CPThemeBlend.ji;14;CPCibLoading.ji;12;CPPlatform.jc;25887;
...
{ with(self)
{
    ...
    {
        objj_msgSend(self, "_openFile:", filename);
        needsUntitled = NO;
    }
...
{ with(self)
{
    objj_msgSend(_documentController, "openDocumentWithContentsOfURL:display:error:", aFilename, YES, NULL);
}
},["void","CPString"])]);
