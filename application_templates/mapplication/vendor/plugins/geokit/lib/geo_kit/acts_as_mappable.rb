  ...
  module ActsAsMappable 
    ...
    module ClassMethods # :nodoc:
      ...
      def acts_as_mappable(options = {})
        ...
        self.qualified_lat_column_name = "y(#{table_name}.geom)" ###### DANIEL COHEN DESIGNS :: Modified to work with GeoRuby
        self.qualified_lng_column_name = "x(#{table_name}.geom)"###### DANIEL COHEN DESIGNS :: Modified to work with GeoRuby
